...
export default {
    async fetch(
        ...
        const after = 0; // TODO: pull from params
        ...
        // for (const activity of activityResp['activities']) {
        //     const metricsResps = await Promise.all(acti);



        //     await fetch(`https://api.nike.com/sport/v3/me/activity/${activity['id']}?metrics=ALL`, {
        //         headers: reqHeaders
        //     }).then((resp) => {
        //         resp.json()
        //     }).then((data) => {
        //         metricsResp[activity['id']] = data;
        //     });
        // }
